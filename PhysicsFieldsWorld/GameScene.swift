...
class GameScene: SKScene {
    ...
    override func didMoveToView(view: SKView) {
        ...
        let titleNode = childNodeWithName("TitleNode") as! SKLabelNode
        titleNode.text = fieldType.rawValue
        
        let tapGestureRecognizer = UITapGestureRecognizer.init(target: self, action: Selector("changeFieldType:"))
        self.view?.addGestureRecognizer(tapGestureRecognizer)
    }
    
    func changeFieldType(sender: UITapGestureRecognizer) {
